Globot - Ai based counselling chatbot
...
4. Every instance can only contain one type of questions, ex. if it is asking for college name then there will only be questions realted to 
   name of our college. No different questions should be put inside same pattern.
5. Give proper tag name else NeuralCode will not work properly.
